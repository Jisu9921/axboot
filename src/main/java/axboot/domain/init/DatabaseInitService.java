package axboot.domain.init;

import axboot.domain.code.CommonCode;
import axboot.domain.code.CommonCodeService;
import axboot.domain.program.Program;
import axboot.domain.program.ProgramService;
import axboot.domain.program.menu.Menu;
import axboot.domain.program.menu.MenuService;
import axboot.domain.user.User;
import axboot.domain.user.UserService;
import axboot.domain.user.auth.UserAuth;
import axboot.domain.user.auth.UserAuthService;
import axboot.domain.user.auth.menu.AuthGroupMenu;
import axboot.domain.user.auth.menu.AuthGroupMenuService;
import axboot.domain.user.role.UserRole;
import axboot.domain.user.role.UserRoleService;
